...
__all__ = [ 'OLE_XPOS_PIXELS', 'Default', 'OLE_XPOS_CONTAINER',
           'FONTSIZE', 'FONTUNDERSCORE', 'OLE_HANDLE', 'StdFont',
           'FONTSTRIKETHROUGH', 'OLE_TRISTATE', 'IPictureDisp',
           'OLE_XPOS_HIMETRIC', 'StdPicture', 'Monochrome',
           'OLE_YPOS_CONTAINER', 'Font', 'OLE_YPOS_PIXELS', 'Checked',
           'VgaColor', 'IFontDisp', 'OLE_CANCELBOOL', 'FONTBOLD',
           'FONTNAME', 'OLE_YSIZE_PIXELS', 'OLE_COLOR', 'Unchecked',
           'LoadPictureConstants', 'OLE_YPOS_HIMETRIC',
           'OLE_XSIZE_PIXELS', 'Picture', 'IFont',
           'OLE_XSIZE_HIMETRIC', 'IPicture', 'OLE_YSIZE_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'FONTITALIC', 'Color', 'FontEvents',
           'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_CONTAINER', 'Gray',
